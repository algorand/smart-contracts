...
APPID=$(${gcmd} app create --creator ${ACCOUNT}   --approval-prog ./newopcodes.teal --global-byteslices 0 --global-ints 0 --local-byteslices 0 --local-ints 0  --clear-prog ./clear.teal | grep Created | awk '{ print $6 }')
