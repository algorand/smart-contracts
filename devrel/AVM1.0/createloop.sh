...
${gcmd} app create --creator ${ACCOUNT}   --approval-prog ./loopsandsub.teal --global-byteslices 0 --global-ints 0 --local-byteslices 0 --local-ints 0  --clear-prog ./clear.teal
